...
public class HardwareTestbot
{
    ...
    public ModernRoboticsDigitalTouchSensor touchSensor;
    public HiTechnicNxtAccelerationSensor accel;
    ...
    public void init(HardwareMap ahwMap) {
        ...
        // Define and initialize ALL instaled sensors
        touchSensor = (ModernRoboticsDigitalTouchSensor) hwMap.touchSensor.get("touch");
        accel = (HiTechnicNxtAccelerationSensor) hwMap.accelerationSensor.get("accel");
    }
